...
public class LobbyManager {
	...
	/**
	 * Gets or creates a new player. If the given UUID is associated with a player,
	 * the player is returned (regardless of lobby). If the UUID is not registered,
	 * it will create a new player, add it to the first lobby and return it. If no
	 * lobby exists yet, one will be created as well.
	 *
	 * @param uuid    The UUID of the player.
	 * @param session The session of the player that will be associated if the
	 ...
	 * Gets or creates a new player. If the given UUID is associated with a player,
	 * the player is returned (regardless of lobby). If the UUID is not registered,
	 * it will create a new player, add it to the given lobby and return it.
	 *
	 * @param uuid    The UUID of the player.
	 * @param session The session of the player that will be associated if the
	 *                player does not exist.
	 * @param lobby   The lobby to add the player to if it is not already
	 *                registered.
	 * @return The player associated with the given UUID.
	 */
